...
:::tip ملاحظة
نفترض في هذا القسم أنه لديك معرفة أساسية بالواجهة التركيبية. إذا كنت تتعلم Vue باستخدام واجهة الخيارات فقط ، يمكنك تعيين تفضيل الواجهة التركيبية (باستخدام زر التبديل في أعلى الشريط الجانبي على اليسار) وإعادة قراءة الفصول [أساسيات واجهة التفاعلية](/guide/essentials/reactivity-fundamentals) و [خطافات دورة الحياة](/guide/essentials/lifecycle).
:::
